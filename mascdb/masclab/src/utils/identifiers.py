"""
Identifier extraction module for MASC analysis.

This module handles the extraction and validation of camera and snowflake
identifiers from MASC image filenames.

Translated from get_cam_id.m (Christophe Praz 2015) and
get_snowflake_id.m (Christophe Praz 2015) and adapted for Python.
