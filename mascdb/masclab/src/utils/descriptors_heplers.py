...
def fit_circle_around(x_perim: np.ndarray, y_perim: np.ndarray, 
                      xh: np.ndarray, yh: np.ndarray) -> Dict[str, float]:
    """
...
def fit_ellipse_inside(x: np.ndarray, y: np.ndarray, x_perim: np.ndarray, 
                       y_perim: np.ndarray, theta: float) -> Dict[str, float]:
    """
...
def fit_ellipse_around(x: np.ndarray, y: np.ndarray, xh: np.ndarray, 
                       yh: np.ndarray, theta: float) -> Dict[str, float]:
    """
...
def haralick_props(data: np.ndarray) -> Dict[str, float]:
    ...
    try:
        ...
        glcm = graycomatrix(data_quant, distances=distances, angles=angles,
