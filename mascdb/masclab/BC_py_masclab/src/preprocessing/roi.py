...
class ROIDetector:
    ...
    def _filter_border_rois(
        ...
        for roi in rois:
            ...
            #### WARNING Hardocded camera IDs based on MATLAB convention ###
            # Might use self.config.camera_order[0/1/2] to determine which cam_id corresponds to which LED position
