"""
This module provides functions to brighten and enhance MASC snowflake images 
using CLAHE (Contrast Limited Adaptive Histogram Equalization) algorithm.

The function modifies and brightens an input picture for improved visibility
and feature detection in further processing steps.

Translated from brightening.m (Christophe Praz 2015)
